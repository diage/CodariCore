...
public class SaveIcon extends ExecutableIcon {
	...
	public void click() {
		...
		if(KitListener.requestedSpawnableGroupNames.containsKey(player.getName())) {
			String groupName = KitListener.requestedSpawnableGroupNames.get(player.getName());
			...
			if(this.kit.createRandomTimeLineGroup()) {
				...
				KitListener.requestedSpawnableGroupNames.remove(player.getName());
