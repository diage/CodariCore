...
public class PersistentObjectSettings extends FunctionMenu {
	...
	public PersistentObjectSettings(Combatant combatant, Kit kit, PersistentObject persistentObject, BackIcon backIcon) {
		super(combatant);
		this.addIcons(combatant, kit, persistentObject, backIcon);
	}

	private void addIcons(Combatant combatant, Kit kit, PersistentObject persistentObject, BackIcon backIcon) {
		...
		super.setSlot(FunctionMenuSlot.C_FIVE, new SetSlotIcon(combatant, new SlotSelection(combatant, kit, persistentObject, kit.getPersistentDelayTime(), kit.getOverride(), new BackIcon(combatant, this))));
	}
}
